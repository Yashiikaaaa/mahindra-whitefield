...
import logo from "../../assets/navbar/Mahindra-Lifespaces.png"; // Importing Prestige Logo
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-0 flex flex-wrap items-center justify-between py-[8px] z-40 ">
          ...
          <div className="hidden lg:flex items-center">
            <a
              ...
              className="flex items-center bg-[#E51937] text-white px-4 py-2 rounded-lg shadow-lg hover:bg-opacity-90 transition"
            >
              <Phone className="w-5 h-5 mr-2" />89194 56501
            </a>
          </div>
        </div>
      </div>
